...
function createTransactionAmount(amount) {
    ...
    if (amount > 0) {
      span.textContent = ` ${formatedAmount} [Entrada] `
      span.classList.add('transaction-amount', 'credit')
    } else {
      span.textContent = ` ${formatedAmount} [Saida]`
...
buttonModal.onclick = function showModal(){
    modal.showModal()
} 

const cancelModal = document.querySelector('#cancelar')
